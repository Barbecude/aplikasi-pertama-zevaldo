    ...
    <style>
        ...
        *,
        ...
        .shadow-\[0px_14px_34px_0px_rgba\(0\2c 0\2c 0\2c 0\.08\)\] {
            ...
            --tw-shadow-colopurple: 0px 14px 34px 0px var(--tw-shadow-color);
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .dark\:hover\:ring-purple-700:hover {
                --tw-ring-opacity: 1;
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="https://laravel.com/docs" id="docs-card"
                            class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-purple-900 dark:ring-purple-800 dark:hover:text-white/70 dark:hover:ring-purple-700 dark:focus-visible:ring-[#FF2D20]">
...
<<<<<<< HEAD
                                ...
                                <div
                                    class="absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-white to-white dark:via-purple-900 dark:to-purple-900">
                                </div>
                            </div>
                        ...
                        <a href="https://laracasts.com"
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-purple-900 dark:ring-purple-800 dark:hover:text-white/70 dark:hover:ring-purple-700 dark:focus-visible:ring-[#FF2D20]">
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24">
